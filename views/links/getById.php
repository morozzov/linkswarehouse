<article class="card-body">
    ...
    <div class="container my-3">
        <a href="/links/addForm" style='text-decoration: none; color: #191c1f;'>
            <div class="row align-items-center rounded-3 linkCard border-success border active">
    ...
    <?php foreach ($data as $link): ?>
        <div class="container my-3">
            ...
            ?> border active">
                <a class="p-0 text-decoration-none text-dark" href="<?= $link->Url ?>" target="_blank">
